...
export default function StorySection() {
  ...
  return (
    <section
      id="system"
      ref={containerRef}
      className="py-44 sm:py-60 relative overflow-hidden flex items-center justify-center select-none"
    >
      <div className="max-w-5xl mx-auto px-6 sm:px-8 text-center space-y-28 sm:space-y-36">
        ...
        <motion.div
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-semibold tracking-tight text-slate-400 dark:text-[#94A3B8]/60 leading-tight"
        >
          YOUR PHONE <br />
        ...
        <div className="w-[1px] h-16 bg-slate-300 dark:bg-white/10 mx-auto" />
