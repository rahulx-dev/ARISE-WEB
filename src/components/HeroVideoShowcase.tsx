...
export default function HeroVideoShowcase() {
  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden select-none border-t border-slate-200/80 dark:border-white/[0.08]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] bg-blue-500/[0.05] rounded-full blur-[200px] pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <motion.div
          ...
          className="relative rounded-3xl p-3 sm:p-4 bg-gradient-to-b from-slate-200/80 to-slate-100/40 dark:from-white/[0.12] dark:to-white/[0.02] shadow-2xl shadow-blue-500/10 dark:shadow-black/90 border border-slate-200 dark:border-white/[0.08]"
        >
