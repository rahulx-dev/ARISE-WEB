...
const nextConfig = {
  env: {
    ...
    VITE_ARISE_APK_DOWNLOAD_URL: process.env.VITE_ARISE_APK_DOWNLOAD_URL || process.env.NEXT_PUBLIC_ARISE_APK_DOWNLOAD_URL || "https://github.com/rahulx-dev/ARISE-WEB/releases/latest/download/ARISE_Final.apk",
    NEXT_PUBLIC_ARISE_APK_DOWNLOAD_URL: process.env.NEXT_PUBLIC_ARISE_APK_DOWNLOAD_URL || process.env.VITE_ARISE_APK_DOWNLOAD_URL || "https://github.com/rahulx-dev/ARISE-WEB/releases/latest/download/ARISE_Final.apk",
